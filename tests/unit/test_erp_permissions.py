...
def test_create_schema_adds_permissions_and_store_scope_to_legacy_users(
    ...
    try:
        ...
        assert inspect(engine).has_table("own_store_personal_watchlist")
        assert inspect(engine).has_table("personal_watchlist_libraries")
        assert inspect(engine).has_table("personal_watchlist_library_items")
        assert inspect(engine).has_table("personal_watchlist_preferences")
